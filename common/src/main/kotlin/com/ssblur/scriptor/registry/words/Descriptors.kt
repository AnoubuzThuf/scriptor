...
object Descriptors {
  val LONG = register(
    "long",
    SimpleDurationDescriptor(3, 7.0, "long")
  )
  val LONGER = register(
    "longer",
    SimpleDurationDescriptor(6, 17.0, "longer")
  )
  val VERY_LONG = register(
    "very_long",
    SimpleDurationDescriptor(65, 120.0, "very_long")
  )
  val STACKING_LONG =
    register(
      "stacking_long",
      SimpleDurationDescriptor(
        6,
        7.0,
        "stacking_long"
      ).allowDuplication()
  ...
  val PERMANENT = register(
    "permanent",
    PermanentDurationDescriptor("permanent")
  )
  val SLOW = register(
    "slow",
    SpeedDurationDescriptor(2, 2.0, 1.25, "slow").allowDuplication()
  )
  val FAST = register(
    "fast",
    SpeedDurationDescriptor(2, -4.0, 1.25, "fast").allowDuplication()
  )
  val CHAIN = register("chain", ChainDescriptor("chain"))
  val SQUARE = register("square", SquareDescriptor("square"))
  val CIRCLE = register("circle", CircleDescriptor("circle"))

  val NETHER = register("nether", NetherDescriptor("nether"))
  val COLLIDE_WITH_WATER = register("collide_with_water", CollideWithWaterDescriptor("collide_with_water"))
//  Summon Behaviours

  val SUMMON_BEHAVIOUR_SENTRY = register(
    "summon_behaviour_sentry",
    SummonBehaviourDescriptor(0, SUMMON_BEHAVIOURS.SENTRY, "summon_behaviour_sentry")
  )
